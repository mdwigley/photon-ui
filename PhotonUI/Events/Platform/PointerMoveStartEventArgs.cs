...
{
    public class PointerMoveStartEventArgs(Window window, InputDeviceKey device, Control source, Control current, Vector2 delta, SDL.FPoint position, SDL.Event e)
        : PlatformEventArgs(e)
    {
